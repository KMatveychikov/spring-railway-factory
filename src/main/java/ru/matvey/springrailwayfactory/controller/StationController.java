...
import ru.matvey.springrailwayfactory.model.dto.AddTrainToStationRequest;
...
public class StationController {
    ...
    public ResponseEntity<Station> addTrainToStation(@RequestBody AddTrainToStationRequest request){
        return ResponseEntity.ok(stationService.addTrainToStation(request.getStationId(), request.getTrainSheetId()));
    }
